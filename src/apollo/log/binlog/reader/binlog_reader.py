...
class BinLogReader:
    ...
    def __init__(self, metadata: BinLogMetadata, binlog_handler: BinLogHandler, instrumentation: Instrumentation, throttling: DynamicThrottling):
        self._lock_object = Lock()
        self._throttling = throttling
        self._instrumentation = instrumentation
        self._binlog_handler = binlog_handler
        self._binlog_handler.set_fail_callback(self._faill_publish_callback)
    ...
    def _faill_publish_callback(self, checkpoint):
        self.stop()
        print('Stop at:', checkpoint.key)
