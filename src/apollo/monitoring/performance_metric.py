...
class PerformanceMetric:
    ...
    def __init__(self):
        self._reported_at = datetime.now() 
    ...
    @property
    def holing_checkpoint_counts(self):
        return self._holing_checkpoint_counts
    
    @holing_checkpoint_counts.setter
    def holing_checkpoint_counts(self, value):
        self._holing_checkpoint_counts = value
    
    @property
    def waiting_checkpoint_counts(self):
        return self._waiting_checkpoint_counts
    
    @waiting_checkpoint_counts.setter
    def waiting_checkpoint_counts(self, value):
        self._waiting_checkpoint_counts = value